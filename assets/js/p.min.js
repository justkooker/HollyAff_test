...
function saveAnswer1(textue) {
  answers.answer1 = textue;
}

function saveAnswer2(textue) {
  answers.answer2 = textue;
}

function saveAnswer3(textue) {
  answers.answer3 = textue;
}
...
function goToUrlFinish() {
  console.log("Ответ 1: ", answers.answer1);
  console.log("Ответ 2: ", answers.answer2);
  console.log("Ответ 3: ", answers.answer3);
}
function stepfinal() {
  jQuery("#p_body_content").fadeOut("slow"),
    jQuery("#p_loading").fadeIn("slow");
...
jQuery(document).ready(function () {
  ...
  $(document).ready(function () {
    $(".bq1").on("click", function () {
      saveAnswer1($("#q1_input").text());
      $("#q1").fadeOut("slow", function () {
        $("#q2").fadeIn("slow");
      });
    }),
      $(".bq2").on("click", function () {
        saveAnswer2($("#q2_input").text());
        $("#q2").fadeOut("slow", function () {
          $("#q3").fadeIn("slow");
        });
      }),
      $(".bq3").on("click", function () {
        saveAnswer3($("#q3_input").text());
        $("#q3").fadeOut("slow", function () {
          $("#q4").fadeIn("slow");
        });
      }),
      $(".bq4").on("click", function () {
        scrollTo("id1"),
